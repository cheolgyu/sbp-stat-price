...
CREATE TABLE IF NOT EXISTS project.tb_52_weeks (
    ...
    "p1x_unit_type" INTEGER NOT NULL,
    "p1x_unit" INTEGER NOT NULL,
...
COMMENT ON COLUMN "project"."tb_52_weeks"."p1x_unit_type" IS '기간 단위 1:주, 2:월';
COMMENT ON COLUMN "project"."tb_52_weeks"."p1x_unit" IS '기간 값';
